...
def main():
    ...
    # 關鍵修正：確保頂層 Prim 被物理引擎識別為 Articulation Root
    ...
    # 設定馬達關節剛度 (Stiffness) 與阻尼 (Damping)
    ...
    print("[INFO] 5/5 模擬啟動！手臂已穩固鎖定，可隨時發送新 target 控制。")
